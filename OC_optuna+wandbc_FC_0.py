...
def objective (trial):
    num_fc_layers = trial.suggest_int("num_fc_layers", 1, 4, log=True)
    #Define Model
    ...
    torch.save(model.state_dict(), "/home/dantheng/OC20/model_FC_only_ckpt.pt")
...
if __name__ == "__main__":
    study_name = "OC_project_FC_only"  # Unique identifier of the study.
