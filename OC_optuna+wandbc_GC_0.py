...
OC_dataset_test_id = oc_dataset(root = "/home/dantheng/OC2/is2res_train_val_test_lmdbs/data/is2re/all/val_id")
...
def objective (trial):
    num_graph_conv_layers = trial.suggest_int("num_graph_conv_layers", 1, 6, log=True)
    #Define Model
    ...
    torch.save(model.state_dict(), "/home/dantheng/OC20/model_GC_only_ckpt.pt")
...
if __name__ == "__main__":
    study_name = "OC_project_Gconv_only"  # Unique identifier of the study.
