...
def objective (trial):
    #Define Model
    num_fc_layers = trial.suggest_int("num_fc_layers", 2, 10, log=False)
    num_graph_conv_layers = trial.suggest_int("num_graph_conv_layers", 3, 10, log=False)
    ...
    torch.save(model.state_dict(), "/home/dantheng/OC20/model_LR_FC_GC_combined_ckpt.pt")
...
if __name__ == "__main__":
    study_name = "OC_LR_FC_GC_combined"  # Unique identifier of the study.
